...
function ButtonIcon({ children, color, title, position = "top", onAction }) {
  return (
    <OverlayTrigger
...
const ButtonSearch = ({ children, setSearch }) => {
  return (
    <div className="w-100 d-flex align-items-center mb-3 mb-lg-0 bg-white border rounded">
      <input
        type="text"
        className="form-control form-control-sm formcontrol-flush"
